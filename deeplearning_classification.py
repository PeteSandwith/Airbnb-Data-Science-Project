...
class AirbnbDataset(Dataset):
    def __init__(self, file):
        ...
        feature_columns = ['guests', 'beds', 'bathrooms', 'Cleanliness_rating', 'Accuracy_rating', 'Communication_rating', 'Location_rating', 'Check-in_rating', 'Value_rating', 'amenities_count', 'Price_Night'],
        label_columns = 'bedrooms')
...
if __name__ == '__main__':
    ...
    print(best_configs)
    print(best_model)
    save_model('neural_networks/regression2/', best_model, best_configs, best_metrics)